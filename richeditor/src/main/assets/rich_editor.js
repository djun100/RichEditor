...
RE.insertImage = function(url, alt) {
    var html = '<img  ontouchstart="gtouchstart(this)" ontouchmove="gtouchmove(this)" ontouchend="gtouchend(this)" src="' + url + '" alt="' + alt + '" style="border:none;visibility:visible;vertical-align:bottom;max-width:100%;zoom:1;"/>';
    RE.insertHTML(html);
}
